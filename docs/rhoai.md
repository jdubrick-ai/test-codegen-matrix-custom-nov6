...
2) Go to the `Data Science Projects` section and access your application's project named `rhdh-custom-ns`

![image](./images/data-science-projects.png)

3) Access the `workbench` named `test-codegen-matrix-custom-nov6-notebook`
...
5) In the terminal, run `cd test-codegen-matrix-custom-nov6` to navigate to your sample app's directory
